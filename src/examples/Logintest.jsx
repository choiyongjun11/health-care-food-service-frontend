...
/*
    ...
    try {
      ...
      if(response.ok) {
        ...
        navigate("/home"); //로그인 성공 시 /home 페이지 이동
      }
...
/*  2번 째 방법)
    ...
    try {
      ...
      if(!response.ok) {
        throw new Error(result.message || "로그인 실패") //throw 를 사용하여 실패 응답이면 바로 catch로 보내버린다.
      }
      ...
      navigate("/");
        ...
        console.error("사용자 정보가 일치하지 않습니다.", error.message);
        setEmail("");
        setPassword("");
        alert("아이디와 비밀번호를 정확히 입력해 주세요.");
